package dev.spring.petclinic.old.findowner.controller;

import dev.spring.petclinic.old.findowner.model.FindOwners;  // Owners 클래스를 import 해야 함
import dev.spring.petclinic.old.findowner.service.FindOwnerService;
